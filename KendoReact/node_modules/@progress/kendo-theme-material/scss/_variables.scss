...
@import "common/material/themeing";
...
$picker-select-padding-x: ($button-padding-y / 2) !default;
$picker-select-padding-y: $button-padding-y !default;
$picker-select-line-height: $line-height !default;

$picker-select-size: add-two($picker-select-padding-x * 2, $icon-size) !default;
...
$colorpicker-draghandle-width: 16px !default;
$colorpicker-draghandle-height: 16px !default;
...
$grouping-header-bg: $widget-border !default;
...
$pager-number-selected-text: $primary-contrast !default;
...
$calendar-cell-selected-text: $primary-contrast !default;
...
$chat-alt-bubble-text: $primary-contrast !default;
...
$datetime-width: add-two($calendar-cell-size * 8, $calendar-content-padding-x * 2);
...
$switch-on-bg: lighten( $accent, 25% ) !default;
...
$switch-on-focused-bg: lighten( $accent, 17% ) !default;
...
$switch-on-handle-bg: $accent !default;
...
$scheduler-current-time-color: #ff0000;
...
$adaptive-menu-text: white;

$adaptive-menu-clear-text: $accent;

$adaptive-menu-item-border: $grid-border;
$adaptive-menu-title-text: $base-text;
...
$spreadsheet-drawing-handle-border-color: $accent !default;
