...
var Window = /** @class */ (function (_super) {
    ...
    function Window(props) {
                ...
                switch (event.keyCode) {
                    ...
                    case kendo_react_common_1.Keys.down:
                        if (_this.windowStage === StageEnum_1.windowStage.FULLSCREEN) {
                            _this.handleRestore(event);
                            kendo_react_common_1.dispatchEvent(_this.props.onStageChange, event, _this, { state: 'DEFAULT' });
                        }
                        else if (_this.windowStage === StageEnum_1.windowStage.DEFAULT) {
                            _this.handleMinimize(event);
                            kendo_react_common_1.dispatchEvent(_this.props.onStageChange, event, _this, { state: 'MINIMIZED' });
                        }
                        break;
                    default:
                }
        ...
        _this.handleFullscreen = function (event) {
            ...
            kendo_react_common_1.dispatchEvent(_this.props.onStageChange, event, _this, { state: 'FULLSCREEN' });
        };
