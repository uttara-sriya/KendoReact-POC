...
var AutoComplete = /** @class */ (function (_super) {
    ...
    AutoComplete.prototype.applyInputValue = function (value, state, eventKey) {
        var opened = this.props.opened !== undefined ? this.props.opened : this.state.opened;
        var _a = this.props, _b = _a.data, data = _b === void 0 ? [] : _b, textField = _a.textField;
        var focusedIndex = this.focusedIndex(value);
        var focusedItem = data[focusedIndex];
        this._suggested = '';
    ...
    AutoComplete.prototype.renderList = function () {
        ...
        var value = this.value;
        var opened = this.props.opened !== undefined ? this.props.opened : this.state.opened;
        return (React.createElement(List_1.default, { id: base.listBoxId, show: opened, data: data.slice(), focusedIndex: this.focusedIndex(), value: value, textField: textField, valueField: textField, highlightSelected: false, optionPrefix: base.optionPrefix, listRef: function (list) { return base.list = list; }, wrapperStyle: { maxHeight: popupSettings.height }, wrapperCssClass: "k-list-scroller", onClick: this.handleItemClick, itemRender: itemRender, noDataRender: listNoDataRender }));
    };
    ...
    AutoComplete.prototype.focusedIndex = function (value) {
        ...
        return this.state.focusedItem !== undefined ?
            data.findIndex(function (i) { return utils_1.areSame(i, _this.state.focusedItem, textField); }) :
            Math.max(0, data.indexOf(utils_1.getFocusedItem(data, value !== undefined ? value : this.value, textField)));
    };
    /**
     * @hidden
     */
